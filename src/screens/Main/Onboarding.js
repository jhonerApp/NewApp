    ...
    const data = [
        {
            ...
            description: 'Choose what you need to send and submit your order.',
            img: require('../../../assets/iconTracker/20945974.jpg')
        },
        {
            _id: '2',
            title: 'Choose a destination',
            description: 'Choose the destination of the pickup.',
            img: require('../../../assets/iconTracker/20943466.jpg')
        },
        {
            _id: '3',
            title: 'Order Delivered',
            description: 'Then the order will be delivered to the receiver as soon as possible.',
            img: require('../../../assets/iconTracker/8640.jpg')
        },
    ]
                ...
                <View style={{
                    ...
                    {/* Show or Hide Next button & GetStarted button by screen */}
                    {
                        currentPage != data.length - 1 ? (
                            ...
                            // Get Started Button
                            <TouchableOpacity onPress={gotoLoginPage} style={{
                                paddingHorizontal: SIZES.base * 2,
                                height: 60,
                                borderRadius: 30,
                                backgroundColor: COLORS.primary,
